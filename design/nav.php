               ...
               <ul>
                   ...
                   <li class="cart" id="cart"><i class="fas fa-shopping-basket"></i> 
                    <span class="badge" id="chart">
                        ...
                        $id_user= $_SESSION['id'];
                        $sql_cartt = "SELECT SUM(count) AS count_sum  FROM cart WHERE id_user = $id_user";
                        $result_cartt = $conn->query($sql_cartt);
                        $row_resultt = $result_cartt->fetch_assoc();
                        $countt = $row_resultt['count_sum'];
                        echo $countt;
