...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:38:48 GMT -->
<head>
...
<section class="about-content-area">
    <div class="video-btn">
        <a href="https://www.youtube.com/watch?v=VWxSoccZzCw" class="video-play-btn mfp-iframe"><i class="fas fa-play"></i></a>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 remove-col-padding">
                <div class="right-content-area rubik gray-bg">
                    ...
                    <h2 class="title rubik">Be More Perfect.</h2>
                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="single-about-bottom-item"><!-- single about bottom item -->
                    <div class="thumb">
                        <img src="assets/img/about/01.jpg" alt="about bottom image">
                    </div>
                    <div class="content">
                        <h4 class="title">What Is Our Mission?</h4>
            ...
            <div class="col-lg-6">
                <div class="single-about-bottom-item"><!-- single about bottom item -->
                    <div class="thumb">
                        <img src="assets/img/about/02.jpg" alt="about bottom image">
                    </div>
                    <div class="content">
                        <h4 class="title">What Is Our Mission?</h4>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution.</p>
...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:39:00 GMT -->
</html>