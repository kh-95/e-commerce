...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:39:01 GMT -->
<head>
                                ...
                                <tr>
                                    <td>
                                        <div class="product-details"><!-- product details -->
                                            ...
                                            <div class="thumb">
                                                <img src="assets/img/cart/01.jpg" alt="cart image">
                                            </div>
                                            <div class="content">
                                                <h4 class="title">Wireless Audio System Multiroom 360</h4>
                                            </div>
                                        </div><!-- //. product detials -->
                                    </td>
                                    <td>
                    ...
                    <div class="bottom-content"><!-- bottom content -->
                        ...
                        <div class="right-content-area">
                            ...
                            <div class="cart-total">
                                ...
                                <ul class="cart-list">
                                    <li>Subtotal <span class="right">$2,299.00</span></li>
                                    <li>Shipping </li>
                                    <li>Calculate shipping </li>
                                    <li>Tax (estimated for Bangladesh)	 <span class="right">$0.00</span></li>
                                    <li class="total">Total <span class="right">$2,299.00</span></li>
                                </ul>
                            </div>
                        </div>
