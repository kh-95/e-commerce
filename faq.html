...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Oct 2018 09:39:45 GMT -->
<head>
...
<section class="faq-page-content-area">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="faq-search-wrapper"><!-- faq search wrapper -->
                    <h4 class="title">Get Every Solutions From There</h4>
                    <form action="http://idealbrothers.thesoftking.com/html/bigenza/bigenja/faq.html" class="faq-search-form">
                        <div class="form-element">
                            <input type="search" class="input-field" placeholder="Type your question here">
                        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-faq-item"><!-- single faq item -->
                    <div class="number">
                        01
                    </div>
                    <div class="content">
                        <h4 class="title">Lorem ipsum dolor sit amet, consectetur adipisicing.</h4>
